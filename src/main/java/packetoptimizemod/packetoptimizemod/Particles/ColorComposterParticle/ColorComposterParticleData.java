...
public class ColorComposterParticleData implements IParticleData {
    ...
    public static final IDeserializer<ColorComposterParticleData> DESERIALIZER = new IDeserializer<ColorComposterParticleData>() {
        public ColorComposterParticleData deserialize(ParticleType<ColorComposterParticleData> particleTypeIn, StringReader reader) throws CommandSyntaxException {
            reader.expect(' ');
        ...
        public ColorComposterParticleData read(ParticleType<ColorComposterParticleData> particleTypeIn, PacketBuffer buffer) {
